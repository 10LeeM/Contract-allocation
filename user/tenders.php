    ...
    <div class="mother-grid">
        <div class="container">
            <div class="temp-padd">
                ...
                <div class="header mb-4">
                    <div class="navg">
                        ...
                        if (isset($_SESSION['userId'])) {
                            ...
                            <li><a class="active" href="tenders.php">Contracts</a></li>
                    ...
                    <form class="search" action="search.php" method="GET">
                        <!-- <div class="search"> -->
                        <input type="text" name="query" value="Contracts search" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Site search';}" />
                ...
                <h4 class="heading-4 text-center mb-4 text-white bg-danger">CONTRACTS</h4>
                <?php
